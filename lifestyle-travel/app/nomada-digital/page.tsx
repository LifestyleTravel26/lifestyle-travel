...
const translations = {
  es: {
    ...
    aplic_systems: [
      { n: '1️⃣', title: 'Aplicación Online (Portal Oficial)', desc: 'Creas cuenta, subes documentos y pagas la tasa en el portal oficial. Todo digital.', examples: 'España, Croacia, Hungría, Costa Rica, Colombia', color: '#22c55e', portals: [['España', 'https://prie.comercio.gob.es'], ['Hungría', 'https://enterhungary.gov.hu'], ['Croacia', 'https://mup.gov.hr'], ['Costa Rica', 'https://migracion.go.cr'], ['Colombia', 'https://www.cancilleria.gov.co']] },
      { n: '2️⃣', title: 'Aplicación Consular', desc: 'Presentas documentos originales en el consulado del país de destino desde tu país de origen.', examples: 'Portugal (Visa D8), Italia, Grecia, México, Argentina', color: '#f59e0b', portals: [['Portugal', 'https://pedidodevistos.mne.gov.pt'], ['México', 'https://www.gob.mx/inm'], ['Argentina', 'https://www.argentina.gob.ar/interior/migraciones']] },
      { n: '3️⃣', title: 'Desde Dentro del País', desc: 'Entras como turista y aplicas a la residencia desde dentro. Puedes abrir banco y preparar documentos localmente.', examples: 'España, Croacia, Georgia, Colombia', color: '#3b82f6', portals: [['Georgia', 'https://migration.commission.ge'], ['Dubai', 'https://visitdubai.com'], ['Colombia', 'https://www.cancilleria.gov.co']] },
    ],
  ...
  pt: {
    ...
    aplic_systems: [
      { n: '1️⃣', title: 'Solicitação Online (Portal Oficial)', desc: 'Você cria conta, sobe documentos e paga a taxa no portal oficial. Tudo digital.', examples: 'Espanha, Croácia, Hungria, Costa Rica, Colômbia', color: '#22c55e', portals: [['Espanha', 'https://prie.comercio.gob.es'], ['Hungria', 'https://enterhungary.gov.hu'], ['Croácia', 'https://mup.gov.hr'], ['Costa Rica', 'https://migracion.go.cr'], ['Colômbia', 'https://www.cancilleria.gov.co']] },
      { n: '2️⃣', title: 'Solicitação Consular', desc: 'Você apresenta documentos originais no consulado do país de destino a partir do seu país de origem.', examples: 'Portugal (Visto D8), Itália, Grécia, México, Argentina', color: '#f59e0b', portals: [['Portugal', 'https://pedidodevistos.mne.gov.pt'], ['México', 'https://www.gob.mx/inm'], ['Argentina', 'https://www.argentina.gob.ar/interior/migraciones']] },
      { n: '3️⃣', title: 'De Dentro do País', desc: 'Você entra como turista e solicita a residência de dentro. Pode abrir banco e preparar documentos localmente.', examples: 'Espanha, Croácia, Geórgia, Colômbia', color: '#3b82f6', portals: [['Geórgia', 'https://migration.commission.ge'], ['Dubai', 'https://visitdubai.com'], ['Colômbia', 'https://www.cancilleria.gov.co']] },
    ],
  ...
  en: {
    ...
    aplic_systems: [
      { n: '1️⃣', title: 'Online Application (Official Portal)', desc: 'You create an account, upload documents and pay the fee on the official portal. All digital.', examples: 'Spain, Croatia, Hungary, Costa Rica, Colombia', color: '#22c55e', portals: [['Spain', 'https://prie.comercio.gob.es'], ['Hungary', 'https://enterhungary.gov.hu'], ['Croatia', 'https://mup.gov.hr'], ['Costa Rica', 'https://migracion.go.cr'], ['Colombia', 'https://www.cancilleria.gov.co']] },
      { n: '2️⃣', title: 'Consular Application', desc: 'You submit original documents at the consulate of the destination country from your home country.', examples: 'Portugal (Visa D8), Italy, Greece, Mexico, Argentina', color: '#f59e0b', portals: [['Portugal', 'https://pedidodevistos.mne.gov.pt'], ['Mexico', 'https://www.gob.mx/inm'], ['Argentina', 'https://www.argentina.gob.ar/interior/migraciones']] },
      { n: '3️⃣', title: 'From Inside the Country', desc: 'You enter as a tourist and apply for residency from inside. You can open a bank account and prepare documents locally.', examples: 'Spain, Croatia, Georgia, Colombia', color: '#3b82f6', portals: [['Georgia', 'https://migration.commission.ge'], ['Dubai', 'https://visitdubai.com'], ['Colombia', 'https://www.cancilleria.gov.co']] },
    ],
