    ...
    <main style={{ minHeight: '100vh', backgroundColor: '#f8f7f4', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <div style={{ padding: '0 20px 40px' }}>
        ...
        <Section id="estrategia" emoji="🏷️" title={t.sec_estrategia_title}>
          ...
          <p style={{ fontSize: '13px', color: '#666', marginBottom: '10px', lineHeight: '1.6' }}>{t.estrategia_sub}</p>
          <div style={T.wrap}>
            <table style={T.table}>
        ...
        <Section id="aterrizaje" emoji="🏦" title={t.sec_aterrizaje_title}>
          ...
          <p style={{ fontSize: '14px', color: '#444', lineHeight: '1.7', marginBottom: '12px' }}>{t.eresidence_p}</p>
          {t.pasos.map((s, i) => (
          ...
          <p style={{ fontSize: '14px', color: '#444', lineHeight: '1.7', marginBottom: '10px' }}>{t.single_permit_p}</p>
