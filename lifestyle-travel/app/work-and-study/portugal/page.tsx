    ...
    <main style={{ minHeight: '100vh', backgroundColor: '#f8f7f4', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <div style={{ padding: '0 20px 40px' }}>
        ...
        <Section id="aterrizaje" emoji="🏦" title="Protocolo de Aterrizaje y Gestión">
          ...
          <p style={{ fontSize: '14px', color: '#1a1a2e', lineHeight: '1.7', marginBottom: '10px' }}>Una vez que tienes base legal (estudios, ingresos remotos o contrato), puedes iniciar el proceso de residencia ante AIMA. Costo aproximado €150-200.</p>
          {[
