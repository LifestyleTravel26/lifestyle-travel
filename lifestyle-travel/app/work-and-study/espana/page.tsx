    ...
    <main style={{ minHeight: '100vh', backgroundColor: '#f8f7f4', fontFamily: 'Inter, system-ui, sans-serif' }}>
      ...
      <div style={{ padding: '0 20px 40px' }}>
        ...
        <Section id="aterrizaje" emoji="🏦" title={t.sec_aterrizaje_title}>
          ...
          <p style={{ fontSize: '14px', color: '#1a1a2e', lineHeight: '1.7', marginBottom: '12px' }}>{t.tie_p}</p>
          {t.pasos.map((s, i) => (
            ...
            <table style={T.table}>
              ...
              <tbody>
                {[
                  ...
                  ['Grupos WhatsApp Latinos', 'Networking', 'Mexicanos, Colombianos, Argentinos en Madrid/Barcelona', 'Ver grupos', 'https://www.facebook.com/search/groups?q=' + encodeURIComponent('Latinos España')],
                ].map((r, i) => (
                  <tr key={i}>
                    <td style={{ ...T.td(i), ...T.bold }}>{r[0]}</td>
                    <td style={T.td(i)}>{r[1]}</td>
        ...
        <Section id="crisis" emoji="🛡️" title={t.sec_crisis_title}>
          ...
          <div style={{ marginTop: '14px', backgroundColor: '#f0fdf4', borderRadius: '8px', padding: '14px' }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
              {([
                ['Mexicanos', 'Mexicanos España'],
                ['Ticos', 'Ticos España'],
                ['Colombianos', 'Colombianos España'],
                ['Argentinos', 'Argentinos España'],
                ['Venezolanos', 'Venezolanos España'],
                ['Peruanos', 'Peruanos España'],
                ['Brasileiros', 'Brasileiros España'],
